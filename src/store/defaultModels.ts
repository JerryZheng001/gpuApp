...
const crossPlatformModels: Model[] = [
  // -------- Gemma --------
  {
    ...
    isDownloaded: false,
    downloadUrl:
      'https://modelscope.cn/models/newsletter/gemma-2-2b-it-Q6_K-GGUF/resolve/master/gemma-2-2b-it.Q6_K.gguf',
    hfUrl: 'https://modelscope.cn/models/newsletter/gemma-2-2b-it-Q6_K-GGUF',
    progress: 0,
    ...
    hfModelFile: {
      ...
      url: 'https://modelscope.cn/models/newsletter/gemma-2-2b-it-Q6_K-GGUF/resolve/master/gemma-2-2b-it.Q6_K.gguf',
      size: 2151393120,
  ...
  },
  {
    ...
    isDownloaded: false,
    downloadUrl:
      'https://modelscope.cn/models/bartowski/Gemmasutra-Mini-2B-v1-GGUF/resolve/master/Gemmasutra-Mini-2B-v1-Q6_K.gguf',
    hfUrl: 'https://modelscope.cn/models/bartowski/Gemmasutra-Mini-2B-v1-GGUF',
    progress: 0,
    ...
    hfModelFile: {
      ...
      url: 'https://modelscope.cn/models/bartowski/Gemmasutra-Mini-2B-v1-GGUF/resolve/master/Gemmasutra-Mini-2B-v1-Q6_K.gguf',
      size: 2151393152,
  ...
  // -------- Phi --------
  {
    ...
    isDownloaded: false,
    downloadUrl:
      'https://modelscope.cn/models/LLM-Research/Phi-3.5-mini-instruct-GGUF/resolve/master/Phi-3.5-mini-instruct-Q4_K_M.gguf',
    hfUrl: 'https://modelscope.cn/models/LLM-Research/Phi-3.5-mini-instruct-GGUF',
    progress: 0,
    ...
    hfModelFile: {
      ...
      url: 'https://modelscope.cn/models/LLM-Research/Phi-3.5-mini-instruct-GGUF/resolve/master/Phi-3.5-mini-instruct-Q4_K_M.gguf',
      size: 2393232608,
  ...
  // -------- Qwen --------
  {
    ...
    isDownloaded: false,
    downloadUrl:
      'https://modelscope.cn/models/Qwen/Qwen2.5-1.5B-Instruct-GGUF/resolve/master/qwen2.5-1.5b-instruct-q8_0.gguf',
    ...
    hfModelFile: {
      ...
      url: 'https://modelscope.cn/models/Qwen/Qwen2.5-1.5B-Instruct-GGUF/resolve/master/qwen2.5-1.5b-instruct-q8_0.gguf',
      size: 1894532128,
  ...
  },
  {
    ...
    isDownloaded: false,
    downloadUrl:
      'https://modelscope.cn/models/Qwen/Qwen2.5-3B-Instruct-GGUF/resolve/master/qwen2.5-3b-instruct-q5_k_m.gguf',
    hfUrl: 'https://modelscope.cn/models/Qwen/Qwen2.5-3B-Instruct-GGUF',
    progress: 0,
    ...
    hfModelFile: {
      ...
      url: 'https://modelscope.cn/models/Qwen/Qwen2.5-3B-Instruct-GGUF/resolve/master/qwen2.5-3b-instruct-q5_k_m.gguf',
      size: 2438740384,
  ...
  },
  {
    ...
    isDownloaded: false,
    downloadUrl:
      'https://modelscope.cn/models/second-state/Llama-3.2-3B-Instruct-GGUF/resolve/master/Llama-3.2-3B-Instruct-Q6_K.gguf',
    hfUrl: 'https://modelscope.cn/models/second-state/Llama-3.2-3B-Instruct-GGUF',
    progress: 0,
    ...
    hfModelFile: {
      ...
      url: 'https://modelscope.cn/models/second-state/Llama-3.2-3B-Instruct-GGUF/resolve/master/Llama-3.2-3B-Instruct-Q6_K.gguf',
      size: 2643853856,
  ...
  // -------- SmolLM --------
  {
    ...
    isDownloaded: false,
    downloadUrl:
      'https://modelscope.cn/models/bartowski/SmolLM2-1.7B-Instruct-GGUF/resolve/master/SmolLM2-1.7B-Instruct-Q8_0.gguf',
    hfUrl: 'https://modelscope.cn/models/bartowski/SmolLM2-1.7B-Instruct-GGUF',
    progress: 0,
    ...
    hfModelFile: {
      ...
      url: 'https://modelscope.cn/models/bartowski/SmolLM2-1.7B-Instruct-GGUF/resolve/master/SmolLM2-1.7B-Instruct-Q8_0.gguf',
      size: 1820414944,
  ...
  // -------- SmolVLM --------
  {
    ...
    isDownloaded: false,
    downloadUrl:
      'https://modelscope.cn/models/ggml-org/SmolVLM-500M-Instruct-GGUF/resolve/master/SmolVLM-500M-Instruct-Q8_0.gguf',
    hfUrl: 'https://modelscope.cn/models/ggml-org/SmolVLM-500M-Instruct-GGUF',
    progress: 0,
    ...
    hfModelFile: {
      ...
      url: 'https://modelscope.cn/models/ggml-org/SmolVLM-500M-Instruct-GGUF/resolve/master/SmolVLM-500M-Instruct-Q8_0.gguf',
      size: 436806912,
      canFitInStorage: true,
    },
