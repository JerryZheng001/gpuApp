...
**iPhone** users can grab it here: [GPUNexus AI on the App Store](https://apps.apple.com/us/app/pocketpal-ai/id6502579498)

**Android** users can get it from here: [GPUNexus AI on Google Play](https://play.google.com/store/apps/details?id=com.pocketpalai)
...
### Available Models
GPUNexus AI comes pre-configured with some popular SLMs:
...
To keep the device running smoothly, GPUNexus AI can automatically manage memory usage:
...
**Developers**: GPUNexus AI is built using React Native. Finding an easy solution that balances text selection with preserved formatting (especially Markdown support) has been tricky for me. If you have experience in this area, I'd love to hear from you!
