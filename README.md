...
本地运行的移动 AI 助手，支持 iOS/Android，完全离线，保护隐私，集成多种小语言模型和 Hugging Face Hub
# GPUNexus AI 📱🚀
...
- **🌐 Localization Support (v1.8.16, Apr, 2025)**: GPUNexus AI now supports multiple languages (At the moment Japanese and Chinese).
...
- **🎨 New Icon Alert (Nov 2024)**: GPUNexus AI has a fresh new look! Huge thanks to **[Chun Te Lee](https://github.com/Reeray)** for the design! [Read more](https://github.com/a-ghorbani/pocketpal-ai/discussions/102).
- **🚀 Hugging Face Public Hub Integration (v1.5, Nov 2024)**: GPUNexus AI now integrates with the Hugging Face model Hub! Browse, download, and run models directly from the Hugging Face Hub within the app. [Read more](https://github.com/a-ghorbani/pocketpal-ai/discussions/104)
...
2. GPUNexus offers two different pal types:
...
4. Share your benchmark results and compare with other devices on the [GPUNexus AI Phone Leaderboard](https://huggingface.co/spaces/a-ghorbani/ai-phone-leaderboard).
...
2. In GPUNexus AI:
   ...
   <img src="assets/images and logos/Token_in_pocketpal.png" alt="Token Setup in GPUNexus" width="66%">
...
GPUNexus AI is built using the amazing work from:
